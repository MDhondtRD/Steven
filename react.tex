...
\section{React Core}
	...
	\subsection{React \emph{createClass}}
		...
		Wanneer een waarde aan het component moet worden doorgegeven gaan we volgende syntax zoals \prettyref{code:propertyname}. Wanneer in de methode \emph{React.render} het object \emph{myComponent} wordt aangemaakt geven we een \emph{property `name'} mee. In \emph{myComponent} wordt verwezen naar de \emph{property name} door gebruik te maken van ``\{this.props.name\}'' om een property op te roepen.
...
\section{React componenten}
	...
	\subsubsection{Mixin}
		...
		\begin{figure}
			...
			\begin{tikzpicture}[every node/.style={decorate,draw,anchor=south west},>=latex,decoration={random steps,segment length=1mm,amplitude=0.5pt},ultra thick]
				{\ECFJD
				\node[draw,minimum width=5cm,minimum height=5.55cm] at (0,0) {};
				\node[draw=graphorange,fill=graphorange,minimum width=5cm,minimum height=1cm] at (0,5.5) {\color{white}State Change};}
				\node[draw=graphlightblue,fill=graphlightblue,minimum width=4cm, minimum height=.75cm] (A) at (.5,.5) {\color{white}componentDidUpdate};
				\node[draw=graphlightblue,fill=graphlightblue,minimum width=4cm, minimum height=.75cm] (B) at (.5,1.75) {\color{white}render};
				\node[draw=graphlightblue,fill=graphlightblue,minimum width=4cm, minimum height=.75cm] (C) at (.5,3) {\color{white}componentWillUpdate};
				\node[draw=graphlightblue,fill=graphlightblue,minimum width=4cm, minimum height=.75cm] (D) at (.5,4.25) {\color{white}shouldComponentUpdate};
				\draw[->,graphorange,decorate] (B) -- (A);
				\draw[->,graphorange,decorate] (C) -- (B);
				\draw[->,graphorange,decorate] (D) -- (C);
			\end{tikzpicture}
	...
	\subsubsection{Should Component Update}
		...
		Elke keer wanneer er een wijziging gebeurd in de \emph{state} of de properties wordt deze functie aangeroepen. Deze functie is een mechanisme die gebruikt kan worden om het opnieuw laden (\emph{render()}) van de component over te slaan, wanneer de wijzigingen geen update nodig hebben.
	...
	\subsubsection{Component Did Update}
		...
		\begin{figure}
			...
			\begin{tikzpicture}[every node/.style={decorate,draw,anchor=south west},>=latex,decoration={random steps,segment length=1mm,amplitude=0.5pt},ultra thick]
				{\ECFJD
				\node[draw,minimum width=5cm,minimum height=6.8cm] at (0,0) {};
				\node[draw=graphorange,fill=graphorange,minimum width=5cm,minimum height=1cm] at (0,6.75) {\color{white}Props Change};}
				\node[draw=graphlightblue,fill=graphlightblue,minimum width=4cm, minimum height=.75cm] (A) at (.5,.5) {\color{white}componentDidUpdate};
				\node[draw=graphlightblue,fill=graphlightblue,minimum width=4cm, minimum height=.75cm] (B) at (.5,1.75) {\color{white}render};
				\node[draw=graphlightblue,fill=graphlightblue,minimum width=4cm, minimum height=.75cm] (C) at (.5,3) {\color{white}componentWillUpdate};
				\node[draw=graphlightblue,fill=graphlightblue,minimum width=4cm, minimum height=.75cm] (D) at (.5,4.25) {\color{white}shouldComponentUpdate};
				\node[draw=graphlightblue,fill=graphlightblue,minimum width=4.5cm, minimum height=.75cm] (E) at (.25,5.5) {\color{white}componentWillRecieveProps};
				\draw[->,graphorange,decorate] (B) -- (A);
				\draw[->,graphorange,decorate] (C) -- (B);
				\draw[->,graphorange,decorate] (D) -- (C);
				\draw[->,graphorange,decorate] (E) -- (D);
